    ...
    return (
        <div className='w-full bg-[#F6F7F9] p-5'>
            ...
            <section className='w-full h-auto flex flex-wrap sm:flex-nowrap space-x-0 sm:space-x-5'>
                ...
                <div className='w-[290px] sm:w-[800px] h-[760px] sm:h-[596px] bg-[#FFFFFF] rounded-lg relative bottom-0 sm:bottom-40 md:bottom-40 lg:bottom-40 p-5 pt-4'>
                    <div>
                    ...
                    <form className='grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-8 p-5 ml-4 lg:ml-0 relative right-5 lg:right-0 rounded-lg bg-[#F6F7F9] w-[260px] lg:w-full '>
                        ...
                        <div className='w-[250px] sm:w-[758px] h-[56px] rounded-lg'>
                            <div className='text-lg space-x-1 lg:space-x-3 flex items-center'>
                                <input
                                    ...
                                    className="appearance-none border-4 border-[#90A3BF] bg-[#3563E9] rounded-full w-[16px] h-[16px] checked:bg-blue-900 checked:border-[#90A3BF]"
                                /> <p>Credit Card</p>
                                <span className='w-24 h-5 flex justify-between pr-3 lg:pr-0'><Image src={"/Visa.png"} alt="" width={92} height={20} className='ml-6 lg:ml-[495px]' /></span>
                            </div>
                        </div>
                        <br />
                        ...
                        <div>
                            ...
                            <input type="text" placeholder='Card Number' className='bg-[#FFFFFF] w-[225px] sm:w-[350px] h-[56px] rounded-md p-7 mt-2 text-sm' />
                        </div>

                        <div>
                            <label className='font-bold'>Expration Date</label><br />
                            <input type="text" placeholder='DD / MM / YY' className='bg-[#FFFFFF] w-[225px] sm:w-[350px] h-[56px] rounded-md p-7 mt-2 text-sm' />
                        </div>

                        <div>
                            <label className='font-bold'>Card Holder</label><br />
                            <input type="text" placeholder='Card Holder' className='bg-[#FFFFFF] w-[225px] sm:w-[350px] h-[56px] rounded-md p-7 mt-2 text-sm' />
                        </div>

                        <div>
                            <label className='font-bold'>CVC</label><br />
                            <input type="text" placeholder='CVC' className='bg-[#FFFFFF] w-[225px] sm:w-[350px] h-[56px] rounded-md p-7 mt-2 text-sm' />
                        </div>
                    </form><br />

                    <div className='w-[255px] sm:w-[758px] h-[56px] bg-[#F6F7F9] rounded-lg p-3 pl-5 flex justify-between items-center'>
                        <div className='text-lg space-x-0 lg:space-x-4 flex items-center '>
                            ...
                            <div><Image src={"/PayPal.png"} alt="" width={100} height={24} className='ml-[45px] sm:ml-[495px] pr-4 lg:pr-0' /></div>
                        </div><br />
                    </div> <br />
                    ...
                    <div className='w-[255px] sm:w-[758px] h-[56px] bg-[#F6F7F9] rounded-lg p-3 pl-5 flex justify-between items-center '>
                        <div className='text-lg space-x-0 lg:space-x-4 flex items-center'>
                            ...
                            <div><Image src={"/Bitcoin.png"} alt="" width={94} height={20} className='ml-[45px] sm:ml-[495px] pr-2 lg:pr-0' /></div>
                        </div><br />
                    </div>
                </div>
            </section> <br />
            ...
            <section className='w-full h-auto flex flex-wrap sm:flex-nowrap space-x-0 sm:space-x-5' >
                ...
                <div className='w-[327px] sm:w-[800px] h-auto bg-[#FFFFFF] rounded-lg relative bottom-0 sm:bottom-40 md:bottom-40 lg:bottom-40 p-5'>
                    ...
                    <form className='grid grid-cols-1 rounded-lg bg-[#FFFFFF]'>
                        <div className='w-[248px] sm:w-[760px] h-[72px] sm:h-[56px] bg-[#F6F7F9] rounded-lg flex items-center pl-4 space-x-5 text-sm sm:text-lg'>
                        ...
                        <br />
                        <div className='w-[248px] sm:w-[760px] h-[68px] sm:h-[56px] bg-[#F6F7F9] rounded-lg flex items-center pl-4 space-x-5 text-sm sm:text-lg'>
